...
// import  { homeObjOne, homeObjThree, homeObjTwo } from "../components/InfoData";
          ...
          <Grid container direction="column">
            <Grid item>
              <Typography variant="h5" className={classes.center} noWrap>
                Your favourite food, delivered with Local&nbsp;&nbsp;
                <span style={{ fontSize: 40 }}>🍽</span>
              </Typography>
            </Grid>
            <Grid item className={classes.SearchBar}>
              <SearchBar className={classes.SearchBar} page="home" action={setLocationStatus} />
            </Grid>
            <Grid item container>
              ...
              <Grid item xs={12} sm={10}>
                {locationStatus ? (
                  ...
                  <Typography variant="body1" className={classes.center} noWrap>
                    Enter your location to view nearby Store
                  </Typography>
                )}
              </Grid>
              <Grid item xs={false} sm={1} />
