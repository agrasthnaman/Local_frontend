...
const useStyles = makeStyles((theme) => ({
  ...
  paper: {
    ...
    backgroundImage: "linear-gradient(315deg, #ffffff 4%, #d7e1ec 74%)",
    borderRadius: "20px",
...
export default function AddRestaurant() {
  ...
  if (errors) {
    for (let error of errors) {
      ...
      if (error.msg.includes("Local Name")) nameError = error.msg;
    }
  }
      ...
      <Grid container>
            ...
            <Grid container>
              <Grid item sm>
                ...
                <form noValidate onSubmit={handleSubmit}>
                  ...
                  >
                    Partner with Local and scale your business
                  </small>
                </form>
              </Grid>
            </Grid>
        ...
        <Grid item xs={3} style={{ marginLeft: "40px" }}>
          ...
          >
            ...
            >
              1. Tell us about your store. <br />
              2. Verify your Email. <br />
              3. Access Local Dashboard and go
              &nbsp;&nbsp;&nbsp;&nbsp;live.
              <br />
              <br />
              <br />
